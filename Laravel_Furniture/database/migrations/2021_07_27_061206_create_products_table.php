...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('pro_slug')->index()->unique(); //bai-viet
            ...
            $table->integer('pro_hot')->index()->default(0);
            $table->integer('pro_active')->index()->default(1);
            ...
            $table->integer('pro_view_start')->default(0);
            $table->timestamps();
        });
    }
